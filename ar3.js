/*
	this js is mainly for testing/eggpain purposes; no real use except $(i)
...
function toRandomOrder(a){var o=[];var w=remakeArray(a);while(w.length){o.push(w.splice(Math.floor(Math.random()*w.length),1)[0]);}return o;}
